  ...
  return (
    <>
      {posts.map(node => {
        ...
        return (
          <article
            className="w-full md:max-w-[400px] mx-2 bg-zinc-100/5 backdrop-blur-sm py-6 px-4 border border-slate-200 shadow-sm hover:-translate-y-1 hover:-translate-x-1 hover:shadow-md transition"
            key={node.id}
          >
            <Link
              to={
